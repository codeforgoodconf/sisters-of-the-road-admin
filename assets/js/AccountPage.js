    ...
    render () {
        ...
        return (
            <div class="AccountPage">
                ...
                <div class="mt5 fr w-50">
                    <button class="f3 br0 ph3 pv0 mb4 db h3 w-80 white bg-purple"
                            onClick={() => this.props.switchView('buycardpage', account)}>
                        <i class="far fa-credit-card pr2"></i>Buy Card 
                    </button>
                    <button class="f3 br0 ph3 pv1 mb4 db h3 w-80 white bg-purple"
                            onClick={() => this.props.switchView('buymealpage', account)}>
                        <i class="fas fa-utensils pr2"></i>Buy Meal
                    </button>
                    <button class="f3 br0 ph3 pv1 mb0 db h3 w-80 white bg-green"
